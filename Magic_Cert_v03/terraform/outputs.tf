...
output "resource_group_by_owner_url" {
  description = "AWS Console URL for V3 resources owned by this deployment"
  value       = module.resource_group.by_owner_group_url
}

output "resource_group_by_version_url" {
  description = "AWS Console URL for V3 resources filtered by Release tag"
...
output "deployment_summary" {
  ...
  value       = <<-EOT
    ...
    Resource Groups:
      ...
      - View V3 resources by owner: ${module.resource_group.by_owner_group_url}
      - View V3 resources by Release tag: ${module.resource_group.by_event_group_url}
